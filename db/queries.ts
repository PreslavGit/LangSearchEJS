...
import { FormData } from "../controllers/AddLang"
...
export async function insertLang(data: FormData){
    console.log(`Insert ${data.name}, ${data.icon}, ${data.popularity}, ${data.performance} into langs `);
